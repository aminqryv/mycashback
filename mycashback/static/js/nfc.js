function nfcileodenis() {
    ...
    || isNaN(onlineInput)  || isNaN(digerInput)) {
        ...
        resultsElement.innerHTML = `
            <div style="color: red; margin-top: 10px; text-align:center;">Kategorilər boş buraxıla bilməz! <br> Əgər daxil edəcəyiniz məbləğ yoxdursa, zəhmət olmasa "0" daxil edin.</div>
        `;
    } else {
    ...
    <div class="row">
        <div class="col-lg-4">
            <div class="container-33">
                ...
                <div class="content">
                    <a style="background: green !important;" href="#">Nagd</a>
                </div>
            </div>
